...
@section('page-header')
    ...
    <div class="breadcrumb-header">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-28 mg-b-1 mg-b-lg-1">مرحبا بالعودة - برنامج ادراة الفواتير</h2>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    المبلغ : {{ number_format(\APP\Models\Invoice::sum('total')) }}
                                </h4>
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if ($count_invoices1 == 0) {
                                            echo $count_invoice1 = 0;
                                        } else {
                                            echo $count_invoices2 = ($count_invoices1 / $count_all) * 100;
                                        }
                                    @endphp
                                </span>
                            </span>
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if ($count_invoices3 == 0) {
                                            ...
                                            echo $count_invoices2 = ($count_invoices3 / $count_all) * 100;
                                        }
                                    @endphp
                                </span>
                            </span>
