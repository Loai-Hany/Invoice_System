                    ...
                    <form action="{{ route('invoices.update', $invoices->id) }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control fc-datepicker" name="invoice_date" type="date"
                                    value="{{ $invoices->invoice_date }}" required>
                            </div>

                            <div class="col-md-4">
                                <label>تاريخ الاستحقاق</label>
                                <input class="form-control fc-datepicker" name="due_date" type="date"
                                    value="{{ $invoices->due_date }}" required>
                            </div>
                        ...
                        <div class="row my-2">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control form-control-lg" id="amount_commission"
                                    name="amount_commission" value="{{ $invoices->amount_commission }}" required>
                            </div>
                        ...
                        <div class="row my-2">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="value_rat" name="value_vat"
