        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto" style="font-size: 28px !important;">الفواتير/</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0" style="font-size: 18px !important;">أرشيف الفواتير</span>
            </div>
        </div>
    ...
    @if (session()->has('delete_invoice'))
        <script>
            window.onload = function() {
                notif({
                    msg: "تم حذف الفاتورة من الأرشيف بنجاح",
                    type: "success"
                })
            }
        </script>
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#"
                                                        ...
                                                        data-target="#Transfer_invoice"><i
                                                            ...
                                                            style="font-size: 16px !important;"></i>&nbsp;&nbsp;نقل الي
                                                        الفواتير</a>
                                                    ...
                                                    <a class="dropdown-item" href="#"
                                                        ...
                                                        data-target="#delete_invoice"><i
                                                            ...
                                                            style="font-size: 16px !important;"></i>&nbsp;&nbsp;حذف
                                                        الفاتورة</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="{{ route('Archeiv.update', 'test') }}" method="post">
                            @csrf
                            @method('PUT')
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="{{ route('Archeiv.destroy', 'test') }}" method="post">
                            @csrf
                            @method('delete')
                    </div>
                    <div class="modal-body">
