    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0" style="font-size: 18px !important;">الفواتير المدفوعة
                    جزئيا</span>
            </div>
        </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="#"
                                                        ...
                                                        style="font-size: 16px !important; border-bottom: 1px solid #ccc;"><i
