...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category" style="font-size: 16px !important;">برنامج الفواتير</li>
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'home')) }}"><svg
                    ...
                    </svg><span class="side-menu__label" style="font-size: 16px !important;">الرئيسية</span></a>
            </li>

            @can('الفواتير')
                <li class="side-item side-item-category" style="font-size: 16px !important;">الفواتير</li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label" style="font-size: 16px !important;">الفواتير</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('قائمة الفواتير')
                            <li><a class="slide-item" href="{{ route('invoices.index') }}"
                                    style="font-size: 16px !important;">قائمة الفواتير</a></li>
                        @endcan
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ route('invoice_paid') }}"
                                    style="font-size: 16px !important;">الفواتير المدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ route('invoice_unpaid') }}"
                                    style="font-size: 16px !important;">الفواتير الغير
                                    مدفوعة</a>
                            </li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ route('invoice_partial_paid') }}"
                                    style="font-size: 16px !important;">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ route('Archeiv.index') }}" style="font-size: 16px !important;">
                                    أرشيف الفواتير </a>
                            </li>
                        @endcan
            ...
            @can('التقارير')
                <li class="side-item side-item-category" style="font-size: 16px !important;">التقارير</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        </svg><span class="side-menu__label" style="font-size: 16px !important;">التقارير</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ route('invoices_report') }}"
                                    style="font-size: 16px !important;">تقارير الفواتير</a></li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ route('customers_report') }}"
                                    style="font-size: 16px !important;">تقارير العملاء</a>
                            </li>
                        @endcan
            ...
            @can('المستخدمين')
                <li class="side-item side-item-category" style="font-size: 16px !important;">المستخدمين</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        </svg><span class="side-menu__label" style="font-size: 16px !important;">المستخدمين</span><i
                            class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        @can('قائمة المستخدمين')
                            <li><a class="slide-item" href="{{ route('users.index') }}"
                                    style="font-size: 16px !important;">قائمة المستخدمين</a>
                            </li>
                        @endcan
                        @can('صلاحيات المستخدمين')
                            <li><a class="slide-item" href="{{ route('roles.index') }}"
                                    style="font-size: 16px !important;">صلاحيات
                                    المستخدمين</a>
                            </li>
                        @endcan
            ...
            @can('الاعدادات')
                <li class="side-item side-item-category" style="font-size: 16px !important;">الاعدادات</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ route('sections.index') }}"
                                    style="font-size: 16px !important;">الأقسام</a></li>
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ route('products.index') }}"
                                    style="font-size: 16px !important;">المنتجات</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
